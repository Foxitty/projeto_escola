...
$route['alunos'] = 'studentController/list';
$route['aluno/criar'] = 'studentController/create';
$route['aluno/(:num)'] = 'studentController/show/$1';
$route['aluno/editar/(:num)'] = 'studentController/edit/$1';
$route['aluno/deletar/(:num)'] = 'studentController/delete/$1';

$route['turmas'] = 'schoolClassController/list';
$route['turma/criar'] = 'schoolClassController/create';
$route['turma/(:num)'] = 'schoolClassController/show/$1';
